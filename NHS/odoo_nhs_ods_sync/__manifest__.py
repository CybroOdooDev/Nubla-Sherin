...
#############################################################################
{
    ...
    'summary': 'Sync NHS Trust records from the NHS Digital ODS portal.',
    'description': """
This module helps synchronise NHS Trust data from the NHS Digital ODS portal.
It supports initial bulk import, daily updates, and conflict handling to keep records accurate and up to date.
""",
