...
class ReportBoardPack(models.AbstractModel):
    """QWeb report parser supplying data for the monthly board pack PDF."""
    _name = 'report.odoo_nhs_incident_risk.report_board_pack'
    _description = 'Monthly Board Pack Report Parser'

    @api.model
    def _get_report_values(self, docids, data=None):
        """Build the rendering context for the board pack report, falling back
        to the current company when printed from a menu item without docids."""
