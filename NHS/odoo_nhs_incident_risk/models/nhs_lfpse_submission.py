...
class NhsLfpseSubmission(models.Model):
    """LFPSE export batch grouping incidents for submission to the NHS England LFPSE portal."""
    ...
    def create(self, vals_list):
        """Assign a sequence-based reference to new export batches."""
    ...
    def action_export(self):
        """Generate the export file in the selected format, attach it to the
        batch, and mark the included incidents as exported."""
        self.ensure_one()
    ...
    def _build_export_data(self):
        """Build the list of row dicts describing each incident for the export file."""
        rows = []
    ...
    def action_mark_submitted(self):
        """Mark the batch and its incidents as submitted to the LFPSE portal."""
        self.ensure_one()
