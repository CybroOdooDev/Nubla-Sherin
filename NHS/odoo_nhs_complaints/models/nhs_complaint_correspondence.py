...
class NhsComplaintCorrespondence(models.Model):
    """Logs a single inbound or outbound correspondence entry (letter, email, call, in-person) for a complaint."""
    ...
    def _compute_display_name(self):
        """Build a human-readable label combining direction, channel and date for each correspondence entry."""
        for rec in self:
    ...
    def unlink(self):
        """Prevent deletion of correspondence log entries since they are statutory records."""
        raise UserError(
