...
class NhsComplaintInvestigation(models.Model):
    """Records the investigation into a formal complaint, including chronology, findings, outcome, and lessons learned."""
    ...
    def create(self, vals_list):
        """Assign an auto-generated sequence reference to new investigations left with the default 'New' name."""
    ...
    def action_create_incident(self):
        """Open the wizard to link or create an incident record for this investigation's complaint."""
        self.ensure_one()
        return {
