...
class NhsIcs(models.Model):
    ...
    _icb_unique = models.Constraint(
        'UNIQUE(icb_id)',
        'An Integrated Care Board (ICB) can only be associated with one Integrated Care System (ICS)!'
    )

    def copy_data(self, default=None):
        """Append '(copy)' to the name and generate a unique ODS code when duplicating an ICS."""
