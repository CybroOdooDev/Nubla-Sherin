...
class NhsRegion(models.Model):
    ...
    def _compute_trust_count(self):
        """Compute the number of trusts per region via an aggregated _read_group count."""
    ...
    def copy_data(self, default=None):
        """Append '(copy)' to the name and generate a unique code when duplicating a region."""
