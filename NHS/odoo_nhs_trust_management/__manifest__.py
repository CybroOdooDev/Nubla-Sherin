...
#############################################################################
{
    ...
    leadership, workflows, security access, and NHS England and Scotland organizational master data within Odoo.
    """,
    ...
    'data': [
        ...
        'views/nhs_board_role_views.xml',
