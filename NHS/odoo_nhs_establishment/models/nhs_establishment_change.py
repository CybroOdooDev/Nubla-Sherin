...
class NhsEstablishmentChange(models.Model):
    """A controlled request to create, delete, re-band, transfer or resize a
    funded post, routed through workforce/finance approval before it is
    applied to the affected post."""
