...
class ResCompany(models.Model):
    """Adds the per-company NHS establishment parameters: FTE hours basis,
    pay on-cost factor and change-control policy."""
...
class ResConfigSettings(models.TransientModel):
    """Exposes the NHS establishment company parameters on the Settings screen."""
