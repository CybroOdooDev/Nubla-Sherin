# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'mail', 'contacts', 'hr', 'hr_skills', 'website','portal', 'account', 'crm'],
    'data': [
        'security/groups.xml',
        'security/ir.model.access.csv',
        'data/sequences.xml',
        'views/fitness_menus.xml',
        'views/fitness_branch_views.xml',
        'views/res_config_settings_views.xml',
        'views/fitness_member_views.xml',
        'views/fitness_attendance_kanban_view.xml',
        ...
        'views/fitness_nutrition_views.xml',
        'views/fitness_crm_views.xml',
        'views/fitness_diet_request_template.xml',
        'views/portal_templates.xml',
        'reports/workout_plan_report.xml',
        'reports/diet_plan_report.xml',
        'reports/fitness_report_template.xml',
    ],
    'assets': {
        'web.assets_frontend': [
